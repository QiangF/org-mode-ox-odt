...
git fetch Orgmode.org

RELEASE=release_9.2.1

git reset --hard $RELEASE

git merge --no-edit Orgmode.org/wip-cite

git checkout 8ad20618d1ff574406dc1ad6e998f400 -- lisp/ox-odt.el

git add lisp/ox-odt.el

git commit -am "ox-odt.el: Revert to 8ad20618d1ff574406dc1ad6e998f400"

# git log --reverse --format=oneline 06bfe66a...417081 >> cherry-picks.sh
...
# git log --reverse --format=oneline 09ea823c2e0f...4bffd4d5e2f1 >> cherry-picks.sh
